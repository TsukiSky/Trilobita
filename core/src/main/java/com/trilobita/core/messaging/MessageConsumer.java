    ...
    public void start() throws ExecutionException, InterruptedException {
        ...
        if (!existing.contains(topic)) {
            try {
                ...
                log.info("[Message] Existing topic: {} do not contain {}! Creating, and then subscribe...", existing, topic);
        ...
        if (runFlag) {
            log.info("[Message] Already listening to topic: {}", topic);
            return;
        }
        runFlag = true;
            ...
            try (Consumer<String, Mail> consumer = new KafkaConsumer<>(consumerProperties)) {
                ...
                while (runFlag) {
                    ...
                    for (ConsumerRecord<String, Mail> consumerRecord : records) {
                        ...
                        if (DEBUG_LOG){
                            log.info("[Message] Consumer Record: Topic: {}, key: {}, value: {}, partition: {}, offset: {}",
