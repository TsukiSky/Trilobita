...
public class MessageConsumer {
    ...
    public MessageConsumer(String topic, Integer serverId, MessageHandler messageHandler) {
        ...
        consumerProperties.put(ConsumerConfig.GROUP_ID_CONFIG, "group-kafka-trilobita-"+ serverId);
        consumerProperties.put(ConsumerConfig.GROUP_INSTANCE_ID_CONFIG, ("consumer-kafka-trilobita-" + topic));
